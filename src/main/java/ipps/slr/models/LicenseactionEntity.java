 ...
 */
@Entity
@Table(name = "licenseaction", schema = "sisslr", catalog = "slr")
public class LicenseactionEntity {
    private long id;
    ...
    @Basic
    @Column(name = "codeaction", nullable = true)
    ...
    public boolean equals(Object o) {
        ...
        LicenseactionEntity that = (LicenseactionEntity) o;
        ...
        if (codeaction != null ? !codeaction.equals(that.codeaction) : that.codeaction != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (codeaction != null ? codeaction.hashCode() : 0);
