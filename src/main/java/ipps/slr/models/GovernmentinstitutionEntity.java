 ...
 */
@Entity
@Table(name = "governmentinstitution", schema = "sisslr", catalog = "slr")
public class GovernmentinstitutionEntity {
    private long id;
    private Timestamp datecreate;
    private Timestamp datelastedit;
    private Long lasteditorid;
    private Long ownerid;
    private Long codegovernmentinstitution;
    private String name;
    ...
    @Basic
    @Column(name = "codegovernmentinstitution", nullable = true)
    public Long getCodegovernmentinstitution() {
        return codegovernmentinstitution;
    }

    public void setCodegovernmentinstitution(Long codegovernmentinstitution) {
        this.codegovernmentinstitution = codegovernmentinstitution;
    }
    ...
    @Basic
    @Column(name = "namecut", nullable = true, length = 128)
    ...
    public boolean equals(Object o) {
        ...
        GovernmentinstitutionEntity that = (GovernmentinstitutionEntity) o;
        ...
        if (codegovernmentinstitution != null ? !codegovernmentinstitution.equals(that.codegovernmentinstitution) : that.codegovernmentinstitution != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (codegovernmentinstitution != null ? codegovernmentinstitution.hashCode() : 0);
