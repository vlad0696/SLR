 ...
 */
@Entity
@Table(name = "typelocality", schema = "sisslr", catalog = "slr")
public class TypelocalityEntity {
    private long id;
    ...
    @Basic
    @Column(name = "nameshort", nullable = true, length = 10)
    ...
    public boolean equals(Object o) {
        ...
        TypelocalityEntity that = (TypelocalityEntity) o;
